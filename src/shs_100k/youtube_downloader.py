...
OUT_DIR = "/home/data/yutanishi/shs-100k/raw"
...
def download_audio(url: str, count: str, song_id: str, version_id: str) -> None:
    filename_template = os.path.join(OUT_DIR, f"{count}_{song_id}_{version_id}")
        ...
        with ThreadPoolExecutor(max_workers=max_workers) as executor:
            for count, row in enumerate(reader):
                ...
                if video_url:
                    ...
                    executor.submit(
                        download_audio, video_url, count_str, song_id, version_id
                    )
